...
function CookingInstructions(props) {
  ...
  useEffect(() => {
    ...
    if(pdpData?.additionalDetails?.cookingGuideProductIds
  ...
  return (
    <div className={`accordions-section ${pdpDetails?.additionalDetails?.cookingGuideProductIds
    && pdpDetails?.additionalDetails?.cookingGuideProductIds?.length > 0 ? '' : 'hide'}`}
    >
                ...
                <div className="cooking-instruction-accordion">
                  <div className="cooking-instruction-caption-accordion">
                    ...
                    <div className="cooking-description-accordion">
                      {description && <HtmlContent contentItemObj={description} isNextJs={true} />}
                    </div>
                  </div>
                </div>
              </div>
