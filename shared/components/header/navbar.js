...
export default function Navbar(props) {
  ...
  return (
    <nav className="container navbar redesign-navbar">
      <div>
        <ul className="navbar-nav nav nav-list">
          <li className="nav-item js-dropdown navListItems">
            ...
            <div className="header-dropdown-menu dropdown-menu firstDropDownMegaMenu">
          ...
          <li className="nav-item js-dropdown navListItems">
            ...
            <div className="header-dropdown-menu dropdown-menu nav-redesign">
